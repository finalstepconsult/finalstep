...
.blogList__section{
  ...
  &--card{
    ...
    &:hover{
      ...
      box-shadow: 2px 2px 3px rgb(223, 78, 107),
                  -2px -2px 3px rgb(223, 78, 107);
  ...
  &--category{
    font-family: $paragraphText, serif !important;
